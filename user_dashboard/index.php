...
<body class="user-main-bg">
  ...
  <div class="container-fluid">
      <?php
        ...
        ?>
    <div class="row">
      <div class="col-lg-2 col-sm-12 m-0 p-0 menu">
      ...
      <div class="col-lg-10 col-sm-12">
        <div class="container">
          ...
          if(!empty($_SESSION['user_id'])){
            ...
            $sql = "SELECT story.*, SC.title as c_name  FROM story INNER JOIN story_category AS SC ON story.category_id = SC.id WHERE status = 'approved'";
            // $sql = 'SELECT story.*, SC.title as c_name  FROM story INNER JOIN story_category AS SC ON story.category_id = SC.id WHERE status = "approved" ';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="autisticOneLabel">User Story</h5>
      ...
      <div class="modal-body">
        ...
        <!--<div class="col-3"><img id="image" src="../images/icon-autistic.png" class="img-fluid mx-auto d-block"></div> -->
          <div class="col-9"><h5><span id="name"></span>, <span id="age"></span></h5><p id="address">Penang, Malaysia</p><p><b id="category">Autistic</b></p></div>
        </div>
            ...
            for (var i = 0; i < btns.length; i++) {
                btns[i].addEventListener('click', function() {
                    ...
                    if (user) {
                        ...
                        document.getElementById('category').innerText = user.category_name;
